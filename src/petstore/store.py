...
class Store:
    ...
    def delete_order(self, request: operations.DeleteOrderRequest) -> operations.DeleteOrderResponse:
        ...
        res = operations.DeleteOrderResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_inventory(self, security: operations.GetInventorySecurity) -> operations.GetInventoryResponse:
        ...
        res = operations.GetInventoryResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get_order_by_id(self, request: operations.GetOrderByIDRequest, accept_header_override: Optional[GetOrderByIdAcceptEnum] = None) -> operations.GetOrderByIDResponse:
        ...
        res = operations.GetOrderByIDResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def place_order_form(self, request: Optional[shared.Order]) -> operations.PlaceOrderFormResponse:
        ...
        res = operations.PlaceOrderFormResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def place_order_json(self, request: Optional[shared.Order]) -> operations.PlaceOrderJSONResponse:
        ...
        res = operations.PlaceOrderJSONResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def place_order_raw(self, request: Optional[bytes]) -> operations.PlaceOrderRawResponse:
        ...
        res = operations.PlaceOrderRawResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
